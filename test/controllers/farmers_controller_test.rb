...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference("Farmer.count") do
      post farmers_url, params: { farmer: { adress: @farmer.adress, description: @farmer.description, name: @farmer.name, user_id: @farmer.user_id } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { adress: @farmer.adress, description: @farmer.description, name: @farmer.name, user_id: @farmer.user_id } }
